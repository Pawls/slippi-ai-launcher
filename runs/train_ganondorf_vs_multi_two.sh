...
# EXPERIMENTAL: Train Ganondorf (RL) vs all 12 top-tier characters (top12 IL, unfrozen).
...
TAG=ganondorf_d18_vs_multi_d21_two_run1
...
python slippi_ai/rl/train_two.py \
  ...
  --config.p2.char=FOX,FALCO,MARTH,SHEIK,JIGGLYPUFF,CPTFALCON,PEACH,YOSHI,POPO,LUIGI,PIKACHU,SAMUS \
  ...
  --wandb.tags=ppo,train_two,multi_char \
  "$@"
